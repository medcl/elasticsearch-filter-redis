...
public class RedisFilterParser implements FilterParser {
    ...
    public Filter parse(QueryParseContext parseContext) throws IOException, QueryParsingException {
                ...
                while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                    if (token == XContentParser.Token.FIELD_NAME) {
                        ...
                        if ("term".equals(currentFieldName)) {
                            ...
                            throw new QueryParsingException(parseContext.index(), "[term] utils does not support [" + currentFieldName + "]");
                        }
                    }
                }
        ...
        if (fieldName == null) {
            throw new QueryParsingException(parseContext.index(), "No field specified for term utils");
        }
